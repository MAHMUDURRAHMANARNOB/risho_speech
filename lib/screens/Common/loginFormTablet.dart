...
class LoginFormTablet extends StatefulWidget {
  ...
  const LoginFormTablet({Key? key, required this.onLoginSuccess})
      : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Container(
            ...
            constraints: BoxConstraints(maxWidth: 600), // Maximum width
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          icon: FaIcon(
                            ...
                            color: Colors
                                .red, // Change the color of the Google logo
                          ),
                        ),
                      ),
                      SizedBox(
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          icon: FaIcon(
                            ...
                            color: Colors
                                .blue, // Change the color of the Google logo
                          ),
                        ),
                      ),
                    ],
